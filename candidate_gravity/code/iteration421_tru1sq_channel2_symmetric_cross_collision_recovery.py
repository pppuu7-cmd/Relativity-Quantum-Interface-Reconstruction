...
iteration420_tru1sq_channel2_symmetric_cross_derivative.py.  Only the iteration
identifier is changed from 420 to 421.  No node, radius, fit basis, threshold,
integrand, sign, normalization, structural check or direct-integrand check is
changed.
"""
...
old='ITERATION=420'
if src.count(old)!=1:
    raise RuntimeError(('iteration420_identity_drift',src.count(old)))
src=src.replace(old,'ITERATION=421',1)
