...
- Latest authoritative research iteration: **Iteration 491**.
...
Canonical run **`34018646528`**, job **`101447018675`**, is **`in_progress`**. It is the sole authorized heavy support gate; do not duplicate it. Raw authority audit and artifact consumption are required before any scientific PASS.
