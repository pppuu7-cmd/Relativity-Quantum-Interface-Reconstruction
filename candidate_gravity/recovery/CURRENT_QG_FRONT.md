...
- Latest authoritative research iteration: **Iteration 494**.
...
Canonical run **`34023698421`**, job **`101460814699`**, is **`in_progress`** on the latest live check. Main scientific stage remains active; raw authority audit and artifact upload are still pending. It is the sole authorized heavy support gate; do not duplicate it. Raw authority audit and artifact consumption are required before any scientific PASS.
...
Readiness change: **0 percentage points**. Iteration 494 closes one exact estimator/provenance diagnostic subgate but no additional stable-rubric component.
