...
- Latest authoritative research iteration: **Iteration 493**.
...
Canonical run **`34023698421`**, job **`101460814699`**, is **`in_progress`** on the latest live check. It is the sole authorized heavy support gate; do not duplicate it. Raw authority audit and artifact consumption are required before any scientific PASS.
...
Readiness change: **0 percentage points**. Iteration 493 closes one local numerical support coordinate but no additional stable-rubric component.
