...
\subsection{Frozen science/reference geometry}
...
\end{equation}
with $x_i$ linearly spanning the campaign. The frozen science and reference templates are
\begin{align}
...
This geometry deliberately separates the $0.5$-Hz science modulation from the $1$-Hz reference modulation while retaining one shared multiplicative scale. The reference phase offset $0.37$ rad is frozen prospectively and is not fitted to improve the Fisher result. The choice is a design architecture, not a claim that these exact modulation frequencies were used in the historical 2008 campaign.
