\section{Detector-facing likelihood and traceable scale closure}
...
\end{loglogaxis}
\end{tikzpicture}
\caption{One-hour statistical/calibration resource boundary for the frozen differential-chirp reference architecture. The total curve follows Eq.~\eqref{eq:floorlaw}. The crossing of the two contributions occurs at $|\theta|\simeq9.38\,\mu g$. This is a design forecast, not an observed RQIR signal amplitude.}
\label{fig:crossover}
\end{figure}
